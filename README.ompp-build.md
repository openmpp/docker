...
Pull: `podman pull openmpp/openmpp-build:redhat-8`
...
## How to use `openmpp/openmpp-build:redhat-8` image

To build openM++ do:
```
podman run ....options... openmpp/openmpp-build:redhat-8 ./build-all
```
Examples:
```
podman run \
