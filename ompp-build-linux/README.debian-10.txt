...
Examples:
  ...
  docker run .... -e MODEL_DIRS=RiskPaths,IDMM      openmpp/openmpp-build:debian-10 ./build-all
  docker run .... -e OM_BUILD_CONFIGS=RELEASE,DEBUG openmpp/openmpp-build:debian-10 ./build-all
  docker run .... -e OM_MSG_USE=MPI                 openmpp/openmpp-build:debian-10 ./build-all
